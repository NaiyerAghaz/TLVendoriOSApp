...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SteppableSlider/SteppableSlider.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TwilioChatClient/TwilioChatClient.framework"
